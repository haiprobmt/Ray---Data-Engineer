...
class ReadRequest(StrictModel):
    operation: Literal["get_item", "list_items", "get_notebook_job", "get_lakehouse", "get_sql_database", "get_environment", "list_lakehouse_tables", "lakehouse_schema", "lakehouse_count", "lakehouse_preview", "tenant_read"]
    workspace_id: str
    item_id: str
    ...
    def table_required(self):
        ...
        if self.operation == "get_notebook_job":
